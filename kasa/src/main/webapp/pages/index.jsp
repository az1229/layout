            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="index.html">
                            <img class="logo" src="img/ks.png" alt="logo">
                            <img class="logo-alt" src="img/ks-alt.png" alt="logo">
                        </a>
                    </div>
                    <!-- /Logo -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="home-content">
                            ...
                            <button class="white-btn" onclick="javascrtpt:window.location.href='#about'">Get Started!</button>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="contact">
                        ...
                        <h3>Address</h3>
                        <p>199-8, youth west road, xicheng street</p>
                    </div>
                </div>
                <!-- /contact -->
                ...
                <div class="col-md-8 col-md-offset-2">
                    <form class="contact-form" action="${pageContext.request.contextPath}/addUser" method="post">
                        <input type="text" class="input" placeholder="Name" name="ksName">
                        <input type="email" class="input" placeholder="Email" name="ksEmail">
                        <input type="text" class="input" placeholder="Subject" name="ksSubject">
                        <textarea class="input" placeholder="Message" name="ksMessage"></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="footer-copyright">
                        <p>Copyright © 2019. All Rights Reserved. Designed by <a href="#" target="_blank">Colorlib</a> More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
                    </div>
                    <!-- /footer copyright -->
